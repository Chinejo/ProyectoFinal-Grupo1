    ...
    <section id="info-planes" className="py-4">
      <Container>
        <div className="planes-contenedor-blanco rounded shadow p-4 p-md-5">
          <h2 className="planes-titulo text-center fw-bold text-uppercase mb-4 pb-3" style={{ fontSize: fontSizes.planesTitle, wordBreak: 'break-word', hyphens: 'auto' }}>
            OFERTA ACADÉMICA
          </h2>
          
          <section className="planes-contenedor-turnos mb-4 border rounded p-3 p-md-4">
            <h3 className="planes-turnos h5 fw-semibold mb-3 pb-2" style={{ fontSize: fontSizes.planesTurnos }}>Turno mañana y tarde:</h3>
            <Accordion>
              <Accordion.Item eventKey="0" className="accordion-item-custom mb-3 border-2 rounded overflow-hidden">
                <Accordion.Header className="fw-semibold" style={{ fontSize: fontSizes.planesAccordion }}>Ciencias Sociales</Accordion.Header>
                <Accordion.Body className="planes-descripcion-body p-3 p-md-4" style={{ fontSize: fontSizes.planesDescription }}>
                  ...
                  <div className="planes-info-box rounded p-3">
                    <dl className="row g-2 mb-0">
                      <dt className="col-12 col-sm-4 col-md-3 planes-dt fw-bold" style={{ fontSize: fontSizes.planesInfoTitle }}>Duración:</dt>
                      <dd className="col-12 col-sm-8 col-md-9 text-dark">6 años</dd>
                      <dt className="col-12 col-sm-4 col-md-3 planes-dt fw-bold" style={{ fontSize: fontSizes.planesInfoTitle }}>Horarios:</dt>
                      <dd className="col-12 col-sm-8 col-md-9 text-dark">De 08:00 a 12:00 en la mañana y de 14:00 a 18:00 en la tarde</dd>
                      <dt className="col-12 col-sm-4 col-md-3 planes-dt fw-bold" style={{ fontSize: fontSizes.planesInfoTitle }}>Edad:</dt>
                      <dd className="col-12 col-sm-8 col-md-9 text-dark">De 12 años a 17 años</dd>
                      <dt className="col-12 col-sm-4 col-md-3 planes-dt fw-bold" style={{ fontSize: fontSizes.planesInfoTitle }}>Alcance:</dt>
              ...
              <Accordion.Item eventKey="1" className="accordion-item-custom mb-3 border-2 rounded overflow-hidden">
                <Accordion.Header className="fw-semibold" style={{ fontSize: fontSizes.planesAccordion }}>Ciencias Naturales</Accordion.Header>
                <Accordion.Body className="planes-descripcion-body p-3 p-md-4" style={{ fontSize: fontSizes.planesDescription }}>
                  <p className="text-dark mb-3 lh-base">
              ...
              <Accordion.Item eventKey="2" className="accordion-item-custom mb-3 border-2 rounded overflow-hidden">
                <Accordion.Header className="fw-semibold" style={{ fontSize: fontSizes.planesAccordion }}>Economía</Accordion.Header>
                <Accordion.Body className="planes-descripcion-body p-3 p-md-4" style={{ fontSize: fontSizes.planesDescription }}>
                  <p className="text-dark mb-3 lh-base">
          ...
          <section className="planes-contenedor-turnos mb-0 border rounded p-3 p-md-4">
            <h3 className="planes-turnos h5 fw-semibold mb-3 pb-2" style={{ fontSize: fontSizes.planesTurnos }}>Turno noche:</h3>
            <Accordion>
              <Accordion.Item eventKey="0" className="accordion-item-custom mb-3 border-2 rounded overflow-hidden">
                <Accordion.Header className="fw-semibold" style={{ fontSize: fontSizes.planesAccordion }}>Economía (Integrado)</Accordion.Header>
                <Accordion.Body className="planes-descripcion-body p-3 p-md-4" style={{ fontSize: fontSizes.planesDescription }}>
                  <p className="text-dark mb-3 lh-base">
              ...
              <Accordion.Item eventKey="1" className="accordion-item-custom mb-3 border-2 rounded overflow-hidden">
                <Accordion.Header className="fw-semibold" style={{ fontSize: fontSizes.planesAccordion }}>Economía (Integrado +17 años)</Accordion.Header>
                <Accordion.Body className="planes-descripcion-body p-3 p-md-4" style={{ fontSize: fontSizes.planesDescription }}>
                  <p className="text-dark mb-3 lh-base">
