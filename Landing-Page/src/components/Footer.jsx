...
const Footer = () => {
  ...
  const handleFooterClick = (event, type, url = null) => {
    console.log('Footer click event:', { type, url, target: event.target });
  ...
  return (
    <footer id="footer" className="footer" style={{ fontSize: fontSizes.footerText }}>
      <Container className="px-3 py-3">
        <Container fluid className="footer-panels px-0">
          <Row className="g-3 align-items-stretch">
            <Col xs={12} lg={6} className="order-2 order-lg-1">
              <Container className="footer-info-panel h-100 px-0">
                <div className="footer-info-content">
                  ...
                  <div className="text-center mb-3">
                    ...
                    <p className="m-0 mb-1" style={{ fontSize: fontSizes.footerSubtitle }}>
                      <button 
                        onClick={(e) => handleFooterClick(e, 'email', 'mailto:esccomreppanama@gmail.com')}
                  ...
                  <div className="text-center">
                    ...
                    <div className="d-flex justify-content-center gap-3">
                      <OverlayTrigger placement="top" overlay={<Tooltip>Link a nuestra página de Facebook</Tooltip>}>
                        <button 
                          onClick={(e) => handleFooterClick(e, 'social', 'https://facebook.com/escueladecomerciorepublicadepanama')}
                      ...
                      <OverlayTrigger placement="top" overlay={<Tooltip>Link a la página del turno noche</Tooltip>}>
                        <button 
                          onClick={(e) => handleFooterClick(e, 'social', 'https://www.facebook.com/profile.php?id=61560700463128&_rdr')}
            ...
            <Col xs={12} lg={6} className="order-1 order-lg-2">
              <Container className="footer-map-panel h-100 px-0">
                <h4 className="text-center fw-normal mb-2" style={{ fontSize: fontSizes.footerSubtitle }}>
                  ¿Dónde encontrarnos?
                </h4>
                <div className="map-container" style={{ marginBottom: 'auto' }}>
                  <iframe
